"""
This script records validation data for the client and server.
It is almost identical to the training data script but changes filepaths.
...
VAL_INPUTS_FILE_PATH = "../shared/val_data/inputs.csv"
VAL_LABELS_FILE_PATH = "../shared/val_data/labels.csv"
...
async def main():
    ...
    while True:
        ...
        write_data(labels.values(), VAL_LABELS_FILE_PATH)
